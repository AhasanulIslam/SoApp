...
console.log("edit info", editInfo );
  ...
  const menu = (
    <Menu>
      ...
      <form className="edit_from">
                  ...
                  <Tooltip placement="topLeft" title="Follow this user">
                    <Button
                      type="primary"
                      shape="round"
                      onClick={() => handleFromSubmit1(editInfo.id)}
                    >
                      <EditOutlined />
                      Edit
                    </Button>
      ...
      <Menu.Item>
        {" "}
        <Tooltip placement="topLeft" title="delete this comment">
          <Button
            type="primary"
            shape="round"
            onClick={() => deleteComment(editInfo.id)}
          >
            Delete
          </Button>
        </Tooltip>
      ...
      <List
        ...
        /> */}
            ...
            <Comment 
              ...
              author={item.first_name + " " + item.last_name}
              avatar={
                <Avatar src={item.profile_picture} alt={item.first_name} />
              }
              content={<p className="comment_list">{item.content}</p>}
